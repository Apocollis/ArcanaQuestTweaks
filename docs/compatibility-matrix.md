...
| `dynamicstealth` | `DynamicStealth-1.12.2.120.jar` | omitted | mixin lives in `mixins.aqtweaks.dss.json` | **yes** (`Sight`, `StealthAttackEvent`, `Attributes`) | yes | **yes** | [reskillable.md](reskillable.md) | Opportunistic redirects `canSee`. Awareness cancels `StealthAttackEvent`. Taunt and Low Profile edit threat generation |
